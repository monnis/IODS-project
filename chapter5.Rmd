...
library(dplyr); library(ggplot2); library(GGally); library(readr); library(tidyr); library(MASS); library(corrplot); library(FactoMineR)
...
Since there's a load of variables, 36 to be exact, with 300 observations, I'm going to limit the number of variables used in the analysis. 
